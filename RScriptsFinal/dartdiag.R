...
######### KC: Importing data
nodes <- read.csv("datafinal/Nodes_dartdiag.csv", header=T, as.is=T)
links <- read.csv("datafinal/Relationships_dartdiag.csv", header=T, as.is=T)
...
links.pal <- c("#edac35", "#64c4eb", "#00ac89")[as.factor(links$type_from)]
